...
if [ "$RELOAD" = "true" ]; then
    ...
    mkdir -p data
    curl -L https://www.dropbox.com/s/94d2wsrrwh1ioyd/weather-non-agg-DFE.csv > data/weather-non-agg-DFE.csv
    curl -L https://www.dropbox.com/s/upz3ijyp7rztse6/weather-evaluated-agg-DFE.csv > data/weather-evaluated-agg-DFE.csv
fi